...
public class Autolote_360DatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public Autolote_360DatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
